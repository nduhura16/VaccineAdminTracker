...
public class Registrationform extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Register Health Centres</h1>");
            try{
                //loading driver
             ...
             //connect to DB
             try{
             con = DriverManager.getConnection("jdbc:mysql://localhost:3306/vaccineadmintarcker", "root", "");
            ...
            String form = "<form action=\"/VaccineAdminTracker/SaveCentre\" method=\"post\">\n" +
"   <table>\n" +
"     <tr>\n" +
"	<td>Hospital name:</td>\n" +
...
"     </tr>\n" +
"     <tr>\n" +
"	<td><input type=\"submit\" value=\"Save centre\"></td>\n" +
"     </tr>\n" +
"   </table>\n" +
"</form>";
            out.println(form);
